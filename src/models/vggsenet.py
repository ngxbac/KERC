...
__all__ = ['SENet', 'vggsenet50', 'vggsenet50_ft']


model_urls = {
    'senet50': '/media/ngxbac/Bac/competition/emotiw/VGGFace2/pretrained/senet50_scratch_weight.pkl',
    'senet50_ft': '/media/ngxbac/Bac/competition/emotiw/VGGFace2/pretrained/senet50_ft_weight.pkl',
}
...
def vggsenet50(pretrained=False, **kwargs):
    """Constructs a SENet-50 model.
    """
    model = SENet(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
        load_state_dict(model, model_urls['senet50'])
        print(" !!! Loaded pretrained weights: ", model_urls['senet50'])

    return model


def vggsenet50_ft(pretrained=False, **kwargs):
    """Constructs a SENet-50 model.
    """
    model = SENet(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
        load_state_dict(model, model_urls['senet50_ft'])
        print(" !!! Loaded pretrained weights: ", model_urls['senet50_ft'])
